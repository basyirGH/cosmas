		...
		<div class="u-clearfix u-sheet u-sheet-1">
			<form action="${request.contextPath}/COSMAS/user"
				...
				<h5 style="color: #5085BA" class="u-text u-text-default u-text-1">
					...
					<span style="color: black"> > Courses > Add New Course
				...
				<div class="u-repeater u-repeater-1">
					<div
						...
						<div
							...
							<a href="${request.contextPath}/COSMAS/file-chooser.jsp"
			...
			<div class="u-form u-form-1">
				<form action="${request.contextPath}/COSMAS/course"
					method="POST"
						...
						<table id="slt-dist-table" class="attribute-8-9-table">
							...
							<tr>
								<td class="first-columns-attribute" rowspan='4' colspan='2'>Course
									...
									id="hideOrShowRows" href="javascript:collapseExpandRows()">Show/Hide
										All </a>
								</td>
							...
							<tr>
								<td colspan="2"><textarea value="0" class="sltdist-topic"
					...
					<div class="u-align-left u-form-group u-form-submit">
						<input type="hidden" value="${course.courseCLOPLOMapping}"
							...
							type="hidden" name="MQFLOforPLOArray" id="MQFLOforPLOArray" />
						<!--  <input type="hidden" name="checkedTrueCLOPLOArray" id="checkedTrueCLOPLOArray"/>-->
						<input type="hidden" name="allChecked" id="allChecked" /> <input
							type="hidden" name="CLOPLOcheckedTrue"
							id="checkedTrueCLOPLOArray" /> <input id="edit-course-submit"
							type="submit" value="Add Course" name="command"
							class="u-btn u-btn-submit u-button-style"> <input
							type="button" value="Clear Unsaved Changes and Exit"
							class="u-btn u-btn-submit u-button-style"> <input
