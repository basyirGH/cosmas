...
<body onload="initPage()" class="u-body">
		...
		<div class="u-clearfix u-sheet u-sheet-1">
				...
				<div class="u-repeater u-repeater-1">
					<div
						...
						<div
							...
							<a
								href="${request.contextPath}/COSMAS/ControllerCourse?command=goToFileChooser&fromCommand=addCourse"
			...
			<div class="">
				<form action="${request.contextPath}/COSMAS/ControllerCourse"
					...
					<table>
						<tr>
							<td rowspan='1' colspan='3'><div
									class="u-form-group u-form-name u-label-left">
									<label for="name-2b64" class="u-label  u-label-6">Course
										Name: </label> <input size="150" type="text" id="name-2b64"
										name="courseName"
										class="u-border-3 u-border-grey-30 u-input u-input-rectangle u-white"
										required="">
								</div></td>
							<td rowspan='1' colspan='2'><div
									class="u-form-email u-form-group u-label-left">
									<label for="email-2b64" class="u-label u-label-6">Course
										Code: </label> <input type="text" id="email-2b64" name="courseCode"
										class="u-border-3 u-border-grey-30 u-input u-input-rectangle u-white"
										required="">
								</div></td>
							<td rowspan='1' colspan='1'><div
									class="u-form-group u-label-left">
									<label for="message-2b64" class="u-label u-label-6">Course
										Classification: </label> <input id="message-2b64"
						...
						<tr>
							<td rowspan='1' colspan='3'><div
									...
									<label for="text-46f2" class="u-label u-label-6">Synopsis:
									</label>
									<textarea id="text-46f2" name="courseSynopsis"
							...
							<td rowspan='1' colspan='3'><div
									...
									<label for="textarea-377c" class="u-label u-label-6">Academic
										Staff(s): </label>
									<textarea id="textarea-377c" name="courseAcadStaff"
										class="u-border-3 u-border-grey-30 u-input u-input-rectangle u-white"
										required=""></textarea>
								</div></td>
						</tr>
						<tr>
							<td><div class="u-form-group u-label-left u-form-group-6">
									<label for="text-f70c" class="u-label u-label-6">Semester
										and Year Offered</label> <input type="text" placeholder=""
										id="text-f70c" name="courseSemYearOffered"
										class="u-border-3 u-border-grey-30 u-input u-input-rectangle u-white">
								</div></td>
							<td rowspan='1' colspan='1'><div
									class="u-form-group u-label-left u-form-group-7">
									<label for="text-2b51" class="u-label u-label-7">Credit
										Value</label> <input type="text" placeholder="" id="text-2b51"
										name="courseCredit"
										class="u-border-3 u-border-grey-30 u-input u-input-rectangle u-white">
								</div></td>
							<td rowspan='1' colspan='4'><div
									class="u-form-group u-label-left u-form-group-8">
									<label for="text-7fdf" class="u-label u-label-8">Pre-requisite/co-requisite
					...
					<div class="u-form-group u-label-left u-form-group-11">
						<label for="text-c8be" class="u-label u-spacing-75 u-label-11">SLT
							Distribution</label> <input type="text" placeholder="" id="text-c8be"
							name="courseSLTDist"
							class="u-border-3 u-border-grey-30 u-input u-input-rectangle u-white">
					</div>
