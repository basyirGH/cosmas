...
<html style="font-size: 16px;">
  ...
  <body onload="initPage()" class="u-body"><header class="u-clearfix u-header u-header" id="sec-2657"><div class="u-clearfix u-sheet u-sheet-1">
          ...
          <div class="u-repeater u-repeater-1">
            <div class="u-align-center-lg u-align-center-md u-align-center-sm u-align-center-xs u-container-style u-hover-feature u-list-item u-repeater-item u-shape-rectangle u-list-item-1">
              <div class="u-container-layout u-similar-container u-container-layout-1">
               <a href="${request.contextPath}/COSMAS/ControllerCourse?command=goToFileChooser&fromCommand=addCourse" class="u-align-center u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-none u-text-palette-1-base u-btn-1"><span class="u-file-icon u-icon u-icon-1"><img src="images/29111922.png" alt="">
               	</span>&nbsp;<br>Extract&nbsp;<br>from Excel
               </a>
              </div>
            </div>
        ...
        <div class="u-form u-form-1">
          <form action="${request.contextPath}/COSMAS/ControllerCourse" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            ...
            <div class="u-form-group u-label-left">
              ...
              <input id="message-2b64" name="courseClassification" class="u-border-3 u-border-grey-30 u-input u-input-rectangle u-white" required="required" type="text">
            </div>
            ...
            <div class="u-form-group u-label-left u-form-group-8">
             ...
             <div class="u-form-group u-label-left u-form-group-8">
              ...
              <textarea placeholder="" id="textarea-378" name="courseLearningOutcomes" class="u-border-3 u-border-grey-30 u-input u-input-rectangle u-white u-input-8"></textarea>
            </div>
             <div class="u-form-group u-label-left u-form-group-8">
              <label for="table-attr-8" class="u-label u-spacing-75 u-label-8">Mapping of the Course Learning Outcomes to Program Learning Outcomes, Teaching Methods and Assessment Methods</label>
              	<table id="table-attr-8" class="attribute-8-table">
					...
					<tr>
						...
						<td> <textarea name="TeachingMethodsForCLO1" id="" ></textarea>  </td>
						<td> <textarea name="AssessmentMethodsForCLO1" id="" ></textarea>  </td>
					</tr>
					<tr>
						...
						<td> <textarea name="TeachingMethodsForCLO2" id="" ></textarea> </td>
						<td> <textarea name="AssessmentMethodsForCLO2" id="" ></textarea>  </td>
					</tr>
					<tr>
						...
						<td> <textarea name="TeachingMethodsForCLO3" id="" ></textarea> </td>
						<td> <textarea name="AssessmentMethodsForCLO3" id="" ></textarea>  </td>
					</tr>
					<tr>
            ...
            <div class="u-form-group u-label-left u-form-group-13">
              ...
              <textarea rows="10" placeholder="" id="text-fb22" name="courseReferences" class="u-border-3 u-border-grey-30 u-input u-input-rectangle u-white"></textarea>
            </div>
