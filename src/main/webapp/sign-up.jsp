        ...
        <div class="u-align-center u-form u-form-1">
          <form action="${request.contextPath}/COSMAS/user" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name">
              <label for="name-047e" class="u-label">Name</label>
              <input type="text" placeholder="Enter your name" id="name-047e" name="userName" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            ...
            <div class="u-form-group u-form-group-4">
              <label for="text-2996" class="u-form-control-hidden u-label"></label>
              <input type="password" placeholder="Re-enter your password" id="text-2996" name="text" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            </div>
            <div class="u-form-group u-form-select u-form-group-5">
              <label for="select-aae8" class="u-label">Role</label>
              <div class="u-form-select-wrapper">
                <select id="select-aae8" name="userRole" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            ...
            <div class="u-align-left u-form-group u-form-submit">
              ...
              <input type="submit" value="Sign Up" name="command" class="u-btn u-btn-submit u-button-style">
            </div>
