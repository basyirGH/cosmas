...
<body class="u-body" onload="validateSession()">
		...
		<div class="u-clearfix u-sheet u-sheet-1">
			<div class="u-align-center u-list u-list-1">
				<div class="u-repeater u-repeater-1">
					<div
						class="u-align-left u-container-style u-hover-feature u-list-item u-repeater-item u-list-item-1"
						...
						<div
							...
							<span class="u-custom-item u-file-icon u-icon u-icon-1"><img
								src="images/2232558.png" alt=""></span>
							<form id="view-courses" method="post"
								action="${request.contextPath}/COSMAS/course">
								<a><input type="submit" name="command" value="Courses"
					...
					<!--  <div
						...
						data-href="Attributes.html" data-page-id="2679530530">
						<div
							class="u-container-layout u-similar-container u-valign-middle u-container-layout-2">
							<span class="u-custom-item u-file-icon u-icon u-icon-2"><img
								src="images/3145497.png" alt=""></span> <a
								href="#"
								class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-none u-text-palette-1-base u-btn-2">Course
								[IN-DEVELOPMENT] Attributes</a>
						</div>
					</div>-->
					<div
						class="u-align-left u-container-style u-hover-feature u-list-item u-repeater-item u-list-item-3"
						data-href="Permissions.html" data-page-id="847323172">
						<div
							class="u-container-layout u-similar-container u-valign-middle u-container-layout-3">
							<span class="u-custom-item u-file-icon u-icon u-icon-3"><img
								src="images/16420971.png" alt=""></span>
							<form id="view-courses" method="post"
								action="${request.contextPath}/COSMAS/request?command=hop-get-requests">
								<a><input type="submit" name="command" value="Requests"
									class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-none u-text-palette-1-base u-btn-1">
								</a>
							</form>
						</div>
					...
					<div
						class="u-container-style u-dialog-link u-hover-feature u-list-item u-repeater-item u-list-item-5"
						data-href="#sec-099c">
						<div
							class="u-container-layout u-similar-container u-valign-middle u-container-layout-5">
							<span class="u-custom-item u-file-icon u-icon u-icon-5"><img
								src="images/709579.png" alt=""></span> <a
								href="${request.contextPath}/COSMAS/user"
								class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-none u-text-palette-1-base u-btn-5">My
								Profile (Account Type: ${loggedIn.userRole})<br>
							<span>${loggedIn.userName}</span>
							</a>
						</div>
					</div>
					<div
						class="u-container-style u-hover-feature u-list-item u-repeater-item u-list-item-4"
						data-href="Courses-Analysis.html" data-page-id="63236393">
						<div
							class="u-container-layout u-similar-container u-valign-middle u-container-layout-4">
							<span class="u-custom-item u-file-icon u-icon u-icon-4"><img
								src="images/2257307.png" alt=""></span> <a
								href="${request.contextPath}/COSMAS/course?command=getCourseVisView"
								class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-none u-text-palette-1-base u-btn-4">Course
								Analysis</a>
						</div>
					</div>
					<div
						class="u-container-style u-hover-feature u-list-item u-repeater-item u-list-item-6">
						<div
							class="u-container-layout u-similar-container u-valign-middle u-container-layout-6">
							<span class="u-custom-item u-file-icon u-icon u-icon-6"><img
								src="images/992680.png" alt=""></span> <a
								href="${request.contextPath}/COSMAS/user?command=logout"
								class="u-border-1 u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-none u-text-palette-1-base u-btn-6">Log
								Out</a>
						</div>
					</div>
				</div>
	...
	<script>
		function validateSession() {
			xhttp.open("GET",
					"${request.contextPath}/COSMAS/user?command=Home", true);
			xhttp.send();
		}
	</script>
	...
	<section
		class="u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-section-8"
		id="sec-099c">
		<div class="u-container-style u-dialog u-white u-dialog-1">
			<div class="u-container-layout u-valign-top u-container-layout-1">
				<h4 class="u-align-left u-text u-text-default u-text-1">My
					Account</h4>
				<div class="u-form u-form-1">
					<form action="#" method="POST"
						class="u-clearfix u-form-spacing-26 u-form-vertical u-inner-form"
						...
						<div class="u-form-group u-form-name u-label-left">
							...
							<input type="text" id="name-2361" name="name"
								class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"
								required="">
						</div>
						<div class="u-form-email u-form-group u-label-left">
							<label for="email-2361" class="u-label u-spacing-32 u-label-2">Email
								Address</label> <input type="email" id="email-2361" name="email"
								class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"
								required="">
						</div>
						<div class="u-form-group u-label-left u-form-group-3">
							...
							<input type="text" placeholder="" id="text-ea5c" name="text"
								class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
						</div>
						<div class="u-form-group u-label-left u-form-group-4">
							<label for="text-9052" class="u-label u-spacing-32 u-label-4">Re-enter
								Password</label> <input type="text" placeholder="" id="text-9052"
								name="text-1"
								class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
						</div>
						<div
							class="u-form-group u-form-select u-label-left u-form-group-5">
							<label for="select-86b4" class="u-label u-spacing-32 u-label-5">Role</label>
							<div class="u-form-select-wrapper">
								<select id="select-86b4" name="select"
									class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
						...
						<div
							class="u-form-checkbox u-form-group u-label-left u-form-group-6">
							<input type="checkbox" id="checkbox-4e3a" name="checkbox"
								value="On"> <label for="checkbox-4e3a"
								class="u-label u-spacing-32 u-label-6">Receive Email
								Notification</label>
						</div>
						<div class="u-align-left u-form-group u-form-submit">
							<a href="#" class="u-btn u-btn-submit u-button-style">Save</a> <input
							...
							<div
								...
								<a href="https://nicepage.com/website-builder"
									...
									class="u-file-icon u-icon u-icon-1"><img
										src="images/51418.png" alt=""></span>&nbsp;<br>Delete All
									Data and&nbsp;<br>Close My Acount </a>
							</div>
						</div>
					</div>
				</div>
		...
		<style class="u-list-item-1 u-state-style">
.u-section-8 .u-list-item-1, .u-section-8 .u-list-item-1:before {
