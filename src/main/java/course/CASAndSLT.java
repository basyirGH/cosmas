...
public class CASAndSLT implements java.io.Serializable  {
	...
	public String getNf2fhour() {
		return nf2fhour;
	}
	public void setNf2fhour(String nf2fhour) {
		this.nf2fhour = nf2fhour;
	}
